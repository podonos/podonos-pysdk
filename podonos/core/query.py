...
class Question(ABC):
    ...
    @classmethod
    def from_dict(cls, data: Dict[TYPE_OF_QUESTION_KEY, Any]) -> "Question":
...
class ScoredQuestion(Question):
    def __init__(self, question: str, options: List[Option], description: Optional[str] = None, order: int = 0):
        super().__init__(question, "SCORED", description, order)
    ...
    @classmethod
    def from_dict(cls, data: Dict[TYPE_OF_QUESTION_KEY, Any]) -> "ScoredQuestion":
        ...
        return cls(question=data["question"], description=data.get("description"), options=options, order=data.get("order", 0))
...
class NonScoredQuestion(Question):
    def __init__(
        ...
        super().__init__(question, "NON_SCORED", description, order)
        self.options = options
    ...
    @classmethod
    def from_dict(cls, data: Dict[TYPE_OF_QUESTION_KEY, Any]) -> "NonScoredQuestion":
        if "options" not in data or not data["options"]:
            raise ValueError("NON_SCORED question must have options")
...
class Instruction(Question):
    def __init__(
        self, instruction: str, category: InstructionCategory, description: Optional[str] = None, order: int = 0, reference_file: Optional[str] = None
    ):
        super().__init__(instruction, "INSTRUCTION", description, order)
    ...
    @classmethod
    def from_dict(cls, data: Dict[TYPE_OF_QUESTION_KEY, Any]) -> "Instruction":
        try:
