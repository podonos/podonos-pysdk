...
def main():
    ...
    etor.add_file(File(path=f"tests/core/speech_two_ch1.wav", model_tag='my_new_model1'))
    etor.add_file(File(path=f"tests/core/speech_two_ch2.wav", model_tag='my_new_model2'))
    etor.close()
