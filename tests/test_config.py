...
class TestEvalConfig(unittest.TestCase):
    ...
    def test_set_eval_use_annotation_valid_types(self):
        ...
        for eval_type in valid_eval_types:
            result = self.eval_config._set_eval_use_annotation(eval_use_annotation=True, eval_type=eval_type)
    ...
    def test_set_eval_use_annotation_invalid_type(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.eval_config._set_eval_use_annotation(eval_use_annotation=True, eval_type=invalid_eval_type)
